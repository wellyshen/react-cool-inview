...
| `unobserveOnEnter` | boolean            | `false`  | Stops observe once the target element intersects with the intersection observer's root. It's useful when you want to trigger the hook once, e.g. [trigger animations](#trigger-animations).                                                                                                                                                              |
